...
import (
	...
	"github.com/rosehsu47/go-lab/sumsup/model"
...
func GetAccessToken() string {
	var defaultLevelName = "basic-kyc-level"
	...
	applicant = CreateApplicant(applicant, defaultLevelName)
	...
	accessToken := GenerateAccessToken(applicant, defaultLevelName)
...
func _makeSumsubRequest(path, method, contentType string, body []byte) ([]byte, error) {
	SumsubAppToken := os.Getenv("APPTOKEN")
	SumsubSecretKey := os.Getenv("SECRETKEY")
